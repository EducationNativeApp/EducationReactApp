...
const CreateAnAccount = ({navigation}) => {
  ...
  console.log(userData)
    Axios.post(`http://192.168.1.108:3001/user/register`, userData)
      .then((response) => {
    ...
    <View style={styles.container}>
     ...
     <View style={styles.nameContainer}>
      ...
      <View style={styles.nameContainer}>
       ...
       <CustomTextInputEmail iconName={faEnvelope} onChangeText={handleEmail} />
      </View>

      <View style={styles.nameContainer}>
        <Text style={[styles.label,{paddingBottom:20.44}]}>Password</Text>
         
<CustomTextInputPassword iconName={faLock} onChangeText={handlePassword}  onBlur={verify} isError={isError} 
