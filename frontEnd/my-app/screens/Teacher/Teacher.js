        ...
        <View>
          ...
          <View style={{ ...styles.imageContainer }}>
            <TouchableOpacity style={styles.imageTextWrapper} onPress={handleNavigateToStudents}>
              ...
              />
              <Text style={{ color: '#66328E', left: 5, fontWeight: '800', marginTop: -5, textAlign: 'center' }}>
                Students
              </Text>
            </TouchableOpacity>
            <View style={{ ...styles.imageTextWrapper, marginLeft: 30, marginTop: 25 }}>
              <Image
                ...
                style={styles.imaged}
              />
              <Text style={{ color: '#66328E', left: 0, fontWeight: '800', textAlign: 'center' }}>contact us</Text>
            </View>
          </View>
        </View>
      </View>
